...
public class TestMail {
	public static void main(String[] args) {
		try {
			String recipient = "nandinikashyap3008@gmail.com";
			...
			String htmlTextMessage = "" + "<html>"
					...
					+ "<h2 style='color:red;'>Welcome to EcommerceHub</h2>" + "<p>Hey,<br>"
					+ "Thanks for singing up with EcommerceHub.<br>"
					...
					+ "<span class='greenText'>NEW500</span><br><br>" + "Have a good day!<br>" + "</p>" + "</body>"
					+ "</html>";
